...
export function BudgetChart() {
  return (
    <div className="glass-card rounded-lg p-5 animate-slide-up">
      <h3 className="text-sm font-semibold text-foreground mb-1">Tren Budget (USD ribu)</h3>
      ...
      <div className="h-[200px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={monthlyBudget}>
            ...
            />
            <Area type="monotone" dataKey="planned" stroke="hsl(220, 70%, 55%)" fill="url(#gradPlanned)" strokeWidth={2} />
            <Area type="monotone" dataKey="actual" stroke="hsl(174, 62%, 47%)" fill="url(#gradActual)" strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
      <div className="flex items-center gap-4 mt-3">
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-0.5 rounded bg-[hsl(220,70%,55%)]" />
